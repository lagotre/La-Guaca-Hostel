...
export default function HabitacionesClient() {
  const { lang } = useLang();
    ...
    <>
      ...
      <section className="relative h-64 md:h-80 flex items-end pb-10 px-4 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/room-twin.jpg"
            alt="Habitaciones La Guaca Hostel Santa Marta"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <h1 className="font-syne font-bold text-4xl md:text-5xl text-white">
            {lang === "es"
              ? "Habitaciones en La Guaca Hostel · Santa Marta"
              : "Rooms & Dorms in Santa Marta"}
          </h1>
        </div>
      </section>
