      ...
      <section className="relative h-64 md:h-80 flex items-end pb-10 px-4 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Santa Marta Colombia vista aérea"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <h1 className="font-syne font-bold text-4xl md:text-5xl text-white">
            {lang === "es"
              ? "Cómo llegar a La Guaca Hostel en Santa Marta"
              : "How to Get to La Guaca Hostel"}
          </h1>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="rounded-card overflow-hidden h-72 md:h-96 bg-crema-dark">
              <iframe
                ...
                title="La Guaca Hostel Location — Barrio Bavaria, Santa Marta"
              />
            </div>
            <a
