...
const idToSlug: Record<string, string> = {
  ...
  "ciudad-perdida": "ciudad-perdida-trek",
  "playa-cristal": "playa-cristal",
  "bahia-concha": "bahia-concha",
  "playa-cinto": "playa-cinto",
  "minca": "minca-tour-dia-completo",
  "velero-tayrona": "velero-tayrona",
  "buceo": "buceo-padi-santa-marta",
};
      ...
      <section className="relative h-64 md:h-80 flex items-end pb-10 px-4 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Tours desde Santa Marta — Tayrona, Ciudad Perdida, Minca"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <h1 className="font-syne font-bold text-4xl md:text-5xl text-white">
            {lang === "es"
              ? "Tours desde Santa Marta: Tayrona, Ciudad Perdida y más"
              : "Tours from Santa Marta: Tayrona, Lost City & More"}
          </h1>
        </div>
      </section>
            ...
            >
              ...
              <div className="w-full lg:w-1/2">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    href={`/tours/${idToSlug[tour.id] ?? ""}`}
                    className="inline-flex items-center gap-2 font-syne font-semibold text-sm border border-terracota text-terracota px-5 py-3 rounded-card hover:bg-terracota hover:text-white transition-colors"
                  >
