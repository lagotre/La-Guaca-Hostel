      ...
      <section className="relative h-56 md:h-72 flex items-end pb-10 px-4 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Área social La Guaca Hostel Santa Marta"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <h1 className="font-syne font-bold text-4xl md:text-5xl text-white">
            {lang === "es" ? "Contacto · La Guaca Hostel" : "Contact · La Guaca Hostel"}
          </h1>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-3 mb-10">
              ...
              <a
                href="mailto:info@laguacahostel.com"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-inter text-xs text-grafito-muted">info@laguacahostel.com</p>
                </div>
